...
import GridUploader from "@/components/grid-generator/GridUploader";
import GridConfigPanel from "@/components/grid-generator/GridConfigPanel";
import GridDisplay from "@/components/grid-generator/GridDisplay";
        ...
        <div className="min-h-screen bg-[#0a0f1a] text-white">
          ...
          <header className="flex items-center justify-between px-6 py-4 border-b border-white/10">
            <div className="flex items-center gap-3">
              <a href="/" className="text-lg font-bold text-orange-400 hover:text-orange-300">
                聚给力
              </a>
